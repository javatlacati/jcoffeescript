...
JCoffeeScript is a java library that compiles CoffeeScript 1.9.3.

### Usage
from the command prompt:
>    echo "a = 1" | java -jar jcoffeescript-1.9.3.jar
<pre>
      (function() {
          var a;
          a = 1;
...
>    java -jar jcoffeescript-1.9.3.jar < foo.coffee > foo.js
